...
def config_parse():
    ...
    # إضافة خيار التمرير المباشر للصورة
    parser.add_argument('--image_path', type=str, default='', help='Direct path to an input image')
    ...
    parser.add_argument('--devive', type=str, default='cpu')
...
def get_pred_result(args):
    ...
    if args.image_path:
        ...
        save_file = os.path.join(pred_dir, image_name + "_result.png")
        image.save(save_file)
        print(f"\n Success! Saved output result to:\n {save_file}")

    else:
        print("Processing dataset list...")
